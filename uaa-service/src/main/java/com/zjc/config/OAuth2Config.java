...
public class OAuth2Config extends AuthorizationServerConfigurerAdapter {
    ...
    protected JwtAccessTokenConverter jwtTokenEnhancer() {
        KeyStoreKeyFactory keyStoreKeyFactory = new KeyStoreKeyFactory(new ClassPathResource("zjc-jwt.jks"), "zjc123".toCharArray());
        JwtAccessTokenConverter converter = new JwtAccessTokenConverter();
        converter.setKeyPair(keyStoreKeyFactory.getKeyPair("zjc-jwt"));
        return converter;
    }
}
